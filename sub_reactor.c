/**************************************************************** 
    ...
    > Date: 2020-07-09 Thu 22:33:22
    > LastEditors: Deser
    > LastEditTime: 2020-07-09 Thu 23:38:09
 ****************************************************************/
#include "head.h"

void* sub_reator(void* arg)
{
    ...
    while (1) {
        DBG(L_RED "Sbu Reactor" NONE " : Epoll Waiting......\n");
        ...
        for(int i = 0; i < nfds; i++){
            ...
            DBG(L_RED "Sbu Reactor" NONE " : %s Ready\n", user->name);
